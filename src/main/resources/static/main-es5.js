...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(portfolioApiService, sharedService, config) {
    ...
    Object.defineProperty(HomeComponent.prototype, "f", {
        get: function () { return this.userGroup.controls; },
        enumerable: true,
        configurable: true
    });
    HomeComponent.prototype.ngOnInit = function () {
    };
    HomeComponent.prototype.close = function (alert) {
        this.alertMessage = "";
        this.alertMessage = null;
    };
    HomeComponent.prototype.submitData = function () {
        var _this = this;
        this.submitted = true;
        if (this.userGroup.valid) {
            ...
            this.portfolioApiService.postApi(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].BASE_URL + 'portfolio/submitPortfolio', reqData).subscribe(function (res) {
                _this.userData = res;
                _this.alertMessage = 'Record Saved Successfully';
                _this.submitted = false;
            });
        }
    };
    HomeComponent.prototype.onlyDecimalNumberKey = function (event) {
        return this.sharedService.onlyDecimalNumberKey(event);
    };
    HomeComponent.prototype.onlyAlphabets = function (event) {
...
var PortfolioApiService = /** @class */ (function () {
    function PortfolioApiService(http) {
        this.http = http;
    }
    /**
      * Generic Get Method
      ...
      */
    PortfolioApiService.prototype.getApi = function (apiUrl) {
    ...
    PortfolioApiService.prototype.errorHandler = function (error, apiURl) {
     ...
     */
    PortfolioApiService.prototype.postApi = function (apiUrl, body) {
        return this.http.post(apiUrl, JSON.stringify(body), { headers: { 'content-type': 'application/json' } })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res; }));
    };
    PortfolioApiService.ctorParameters = function () { return [
...
var SharedService = /** @class */ (function () {
    ...
    SharedService.prototype.onlyDecimalNumberKey = function (event) {
        var e = event;
    ...
    SharedService.prototype.onlyAlphabets = function (event) {
    ...
    SharedService.prototype.getFormatedDate = function (date) {
        var month;
        var day;
        if (date.month < 10) {
            month = "0" + date.month;
